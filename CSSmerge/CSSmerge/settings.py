"""
Django settings for CSSmerge project.
...
SECRET_KEY = 'django-insecure-*nd5gly6xf8ygtz-&!$hkih3ijb_)tyssglxzagz6)o@j%a=ck'
...
WSGI_APPLICATION = 'CSSmerge.wsgi.application'
